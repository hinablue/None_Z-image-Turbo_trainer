...
# -*- coding: utf-8 -*-
"""
Z-Image Text Encoder Cache Script (Standalone - Multi-GPU Safe)
...
def main():
    parser = argparse.ArgumentParser(description="Cache text embeddings for Z-Image training (Multi-GPU Safe)")
